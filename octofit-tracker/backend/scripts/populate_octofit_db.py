#!/usr/bin/env python3
"""
Script to populate the octofit_db MongoDB database with test data for users, teams, activities, leaderboard, and workouts.
- Superheroes as users
- Teams: Marvel and DC
- Ensures unique index on email for users
"""
